document.addEventListener('DOMContentLoaded', function () {
    ...
    let netSpan = document.getElementById('net');
    ...
    function updateAllNumbers() {
        ...
        //
        complementarySpan.innerText = totalNights * dayPrice - advancedPayment - discount;
        //
        netSpan.innerText = totalNights * dayPrice - discount;
